...
import kotlinx.android.synthetic.main.ads_viewpagerslide.view.*
...
class SliderAdapter(activity: FragmentActivity, sliders: List<Result>) : PagerAdapter() {

    private val context: Context
    private val slidersData: List<Result> = sliders
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        val view = layoutInflater.inflate(R.layout.ads_viewpagerslide, container, false)
        loudImage(context,view.im_slider,slidersData[position].Adsimage)
